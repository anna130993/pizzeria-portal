        ...
        <CardContent>
          ...
          <form noValidate autoComplete='off'>
            <Grid container spacing={2}>
              ...
              <Grid item>
                <TextField className={styles.input} id='time' label='Time' type='time' value='12:30' InputLabelProps={{shrink: true}} inputProps={{step:300, readOnly: isReadOnly}} />
              </Grid>
              <Grid item>
              ...
              <Grid item>
                <TextField label='Duration' value={2} type='number' InputProps={{readOnly: isReadOnly}} InputLabelProps={{shrink: true}} />
              </Grid>
              <Grid item>

...
const columns = [
  ...
  { field: 'timestamp', headerName: 'Time of order', flex: 1},
          ...
          <Card>
            <CardContent>
              <Grid container spacing={2} direction="column">
                ...
                <Grid item>
                  <DataGrid className={styles.dataGrid} rows={rows} columns={columns} rowHeight={175} autoHeight disableColumnSelector disableSelectionOnClick disableColumnMenu hideFooter showCellRightBorder onRowClick={params => toggleDone(params.row.id)}/>
                </Grid>
              </Grid>
            </CardContent>
          </Card>
